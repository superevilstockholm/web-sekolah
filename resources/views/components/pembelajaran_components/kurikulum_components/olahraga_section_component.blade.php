        ...
        <div class="row mb-4">
            <div class="col">
                <img class="img-fluid w-100 rounded"
                    src="https://sph.edu/wp-content/uploads/2022/02/sph-academic-sports-top-v1.jpg" alt="Olahraga Al-Layyinah">
            </div>
        </div>
            ...
            <div class="col-md-6 col-12 mb-4 mb-md-0">
                <div class="d-flex flex-column gap-3">
                    ...
                    <p style="line-height: 1.9 !important;">
                        ...
                        Hal ini sejalan dengan tujuan pendidikan kami untuk mencetak generasi sehat, kuat, dan berakhlak mulia.
                    </p>
                </div>
            </div>
            <div class="col-md-6 col-12">
                <img class="img-fluid w-100 h-100 object-fit-cover rounded" style="max-height: 600px;"
                    src="https://sph.edu/wp-content/uploads/2022/02/sph-academic-sports-side-v1.jpg" alt="Olahraga Santri">
            </div>
        </div>
