<section class="mb-4 mb-md-5" id="olahraga">
    <div class="container">
        <div class="row mb-4">
            <div class="col">
                <img class="img-fluid w-100 rounded"
                    src="https://sph.edu/wp-content/uploads/2022/02/sph-academic-sports-top-v1.jpg" alt="">
            </div>
        </div>
        <div class="row mb-4 align-items-center">
            ...
            <div class="col-md-6 col-12">
                <img class="img-fluid w-100 h-100 object-fit-cover rounded" style="max-height: 600px;"
                    src="https://sph.edu/wp-content/uploads/2022/02/sph-academic-sports-side-v1.jpg" alt="">
            </div>
        </div>
        <div class="row py-3 mb-4">
            ...
            <div class="col-md-6 col-12">
                <h4 class="fw-normal">Di 5 kampus, Tim Olahraga SPH sering disebut sebagai The Eagles.</h4>
                <p class="text-muted" style="line-height: 1.9 !important;">Sejumlah kegiatan sepulang sekolah untuk Junior dan Senior Schools, seperti sepak bola, basket, trek dan lapangan, bulu tangkis, “touch rugby” dan renang, juga menjadi bagian dari Eagles Team.</p>
            </div>
        </div>
    </div>
</section>
