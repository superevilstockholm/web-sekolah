    ...
    <div class="container">
        ...
        <div class="row mb-4 align-items-center">
            <div class="col-md-6 col-12 mb-4 mb-md-0">
                ...
                <h1 class="faq-title fw-normal p-0 m-0 mb-3 text-black"><span class="faq-title text-primary">Menguatkan</span> Iman di Bulan Suci</h1>
                <p class="mb-3" style="line-height: 1.9 !important;">Pesantren Kilat Ramadhan dilaksanakan dengan kegiatan seperti kajian tafsir, tadarus Al-Qur’an,
