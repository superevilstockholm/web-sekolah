    ...
    <div class="container">
        ...
        <div class="row mb-4 align-items-center">
            <div class="col-md-6 col-12 mb-4 mb-md-0">
                ...
                <h1 class="fw-normal p-0 m-0 mb-3"><span class="text-primary">Pengalaman Penelitian</span> bersama Ahli
                </h1>
                <p class="text-muted" style="line-height: 1.9 !important;">Applied Science Academy (ASA) adalah
        ...
        <div class="row justify-content-center mb-4">
            <div class="col-md-6 col-12">
                <p class="text-muted mb-3" style="line-height: 1.9 !important;">Pada tahun 2018, SPH mendirikan Center
                ...
                <p class="text-muted" style="line-height: 1.9 !important;">ASA beranggotakan siswa Kelas 10-12 yang
