    ...
    <div class="container">
        ...
        <div class="row mb-4 align-items-center">
            <div class="col-md-6 col-12 mb-4 mb-md-0">
                ...
                <h1 class="faq-title fw-normal p-0 m-0 mb-3" style="color: #3a3b3c;">Pertolongan Medis dari <span class="faq-title text-primary">Profesional</span>
                </h1>
            ...
            <div class="col-md-6 col-12 mb-4 mb-md-0">
                <img class="img-fluid w-100 h-100 object-fit-cover rounded" style="max-height: 600px;"
                    src="https://sph.edu/wp-content/uploads/2022/02/sph-studentLife-healthCenter-side-v1.jpg" alt="">
            </div>
        </div>
    </div>
</section>
