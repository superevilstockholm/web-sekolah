    ...
    <div class="container">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <p class="fw-normal text-muted mb-3">Terletak 45 menit dari Jakarta, SPH Sentul City menawarkan
                    fasilitas
                ...
                <p class="fw-normal text-muted mb-3">Siswa yang tinggal di PHH mendapatkan pengalaman pendidikan yang
                ...
                <p class="fw-normal text-muted">Di PHH, fokus kami adalah memperhatikan pengembangan setiap siswa untuk
