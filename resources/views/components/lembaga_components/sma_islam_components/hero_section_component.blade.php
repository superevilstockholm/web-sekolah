<section class="mt-3">
    <div class="container">
        <h1 class="text-center py-2 text-muted fw-normal">SPH Lippo Cikarang</h1>
        <h2 class="text-center mb-5 py-2 text-muted fw-normal">Rumah Kedua Keluarga Anda</h2>
        <div class="row align-items-center">
            <div class="col-12 col-md-6 col-lg-6 mb-4 mb-md-0">
                <img class="img-fluid rounded" src="https://sph.edu/wp-content/uploads/2022/02/header-sph-ourSchools-lippoCikarang-v1.jpg"
                    alt="">
            </div>
            <div class="col-lg-1 d-none d-lg-block"></div>
            <div class="col-12 col-md-6 col-lg-4">
                <p class="fw-semibold mb-2 text-muted">Sebagai sekolah internasional di Pluit Village, kami menerapkan
