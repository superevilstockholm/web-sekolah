        ...
        <div class="row py-3 mb-4">
            ...
            <div class="col-md-6 col-12">
                ...
                <div class="mb-2 d-flex align-items-start gap-2">
                    <img src="https://sph.edu/wp-content/uploads/2021/08/SPH-Rectangle.png" height="12"
                        alt="">
                    <p class="text-muted mb-0"><strong>Tim </strong> <em> Learning Support</em> <strong>yang inklusif
                        </strong>
                ...
                <div class="mb-2 d-flex align-items-start gap-2">
                    <img src="https://sph.edu/wp-content/uploads/2021/08/SPH-Rectangle.png" height="12"
                        alt="">
                    <p class="text-muted mb-0"><em><strong>Center of Excellence in Applied Science</strong></em>
                ...
                <div class="mb-2 d-flex align-items-start gap-2">
                    ...
                    <p class="text-muted mb-0">Tim pendidik yang merupakan pemimpin dan pionir dalam pendidikan Kristen
                        dengan <a href="https://sph.edu/id/pembelajaran/program/international-baccalaureate/">kurikulum
                            IB di Indonesia</a> yang berkomitmen untuk memberikan <strong>pendidikan IB yang visioner</strong>
                    </p>
                </div>
