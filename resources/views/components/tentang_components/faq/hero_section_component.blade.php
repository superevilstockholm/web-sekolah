<section class="mt-3 mb-5 faq-section">
    <div class="container">
        <h1 class="faq-title text-center mb-5 py-2 fw-normal" style="color: #3a3b3c;">Frequently Asked Questions</h1>
        <div class="row justify-content-center">
            <div class="col-md-7 col-12">
                ...
                <h1 class="faq-title fw-normal p-0 m-0 mb-3" style="color: #3a3b3c;">Kehidupan <span class="text-primary faq-title">Siswa Al-Layyinah</span></h1>
                <p class="text-muted mb-2" style="line-height: 1.9 !important;">Kami menyiapkan daftar pertanyaan yang
