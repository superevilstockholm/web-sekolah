<section class="mt-3 mb-5 faq-section">
    <div class="container">
        <h1 class="faq-title text-center mb-5 py-2 text-black fw-normal">Frequently Asked Questions</h1>
        <div class="row justify-content-center">
            <div class="col-md-7 col-12">
                ...
                <h1 class="faq-title fw-normal p-0 m-0 mb-3 text-black">Kehidupan <span class="text-primary faq-title">Siswa Al-Layyinah</span></h1>
