<section class="mt-3 mb-5">
    <div class="container">
        <h1 class="text-center mb-5 py-2 text-muted fw-normal">Frequently Asked Questions</h1>
        <div class="row justify-content-center">
            <div class="col-md-7 col-12">
                ...
                <h1 class="fw-normal p-0 m-0 mb-3">Kehidupan <span class="text-primary">Siswa Al-Layyinah</span></h1>
