...
@section('content')
    ...
    {{-- Hero Section --}}
    @include('components.berita_dan_acara_components.acara_components.hero_section_component')
    {{-- Acara List Section --}}
    @include('components.berita_dan_acara_components.acara_components.acara_listing_section_component')
