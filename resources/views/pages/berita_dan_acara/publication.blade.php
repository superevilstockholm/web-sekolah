...
@section('content')
    ...
    {{-- Hero Section --}}
    @include('components.berita_dan_acara_components.publikasi_components.hero_section_component')
    {{-- Publikasi Section --}}
    @include('components.berita_dan_acara_components.publikasi_components.publikasi_section_component')
